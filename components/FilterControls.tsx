...
const FilterControls: React.FC<FilterControlsProps> = ({ activeFilter, searchTerm, onFilterChange, onSearchChange }) => {
    ...
    return (
        <div className="mb-12 sticky top-4 z-30 bg-gray-900/80 backdrop-blur-sm p-4 rounded-xl">
            <div className="max-w-4xl mx-auto">
                <div className="relative mb-4">
                    ...
                    <input
                        className="w-full bg-gray-800 text-white placeholder-gray-400 border border-gray-700 rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent"
                        type="text"
                        id="search-input"
